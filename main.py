"""Данный модуль рассчитывает работу фитнес-трекера."""
...
def show_message(time: dt.time, steps: int,
                 dist: float, calories: float, achiev: str) -> None:
...
def accept_package(data: tuple) -> str | dict:
